...
ScAddr Keynodes::action_scp_interpretation_request;
ScAddr Keynodes::action_initiated;
ScAddr Keynodes::action_finished;
ScAddr Keynodes::action_finished_successfully;
ScAddr Keynodes::action_finished_unsuccessfully;
ScAddr Keynodes::action_finished_with_error;
