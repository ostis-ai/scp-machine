...
#include "SCPOperatorContDiv.hpp"
...
SCPOperatorContDiv::SCPOperatorContDiv(ScMemoryContext &ctx, ScAddr addr): SCPOperatorElStr3(ctx, addr)
{
}

std::string SCPOperatorContDiv::GetTypeName()
{
    return "contDiv";
}

sc_result SCPOperatorContDiv::Parse()
{
