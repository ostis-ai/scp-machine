...
sc_result SCPOperatorIfGr::Execute()
{
  ...
  if (Utils::scLinkContentIsInt(m_memoryCtx, operands[0]->GetValue())
      && Utils::scLinkContentIsInt(m_memoryCtx, operands[1]->GetValue()))
  {
    std::cout << "Links are int" << std::endl;
    if (Utils::scLinkGetContentInt(m_memoryCtx, operands[0]->GetValue())
        > Utils::scLinkGetContentInt(m_memoryCtx, operands[1]->GetValue()))
    {
    ...
    else
    {
      ...
      Utils::scLinkContentIsUint(m_memoryCtx, operands[0]->GetValue())
      && Utils::scLinkContentIsUint(m_memoryCtx, operands[1]->GetValue()))
  {
    std::cout << "Links are uint" << std::endl;
    if (Utils::scLinkGetContentUint(m_memoryCtx, operands[0]->GetValue())
        > Utils::scLinkGetContentUint(m_memoryCtx, operands[1]->GetValue()))
    {
      FinishExecutionSuccessfully();
    }
    else
    {
      ...
      Utils::scLinkContentIsFloat(m_memoryCtx, operands[0]->GetValue())
      && Utils::scLinkContentIsFloat(m_memoryCtx, operands[1]->GetValue()))
  {
    std::cout << "Links are float" << std::endl;
    if (Utils::scLinkGetContentFloat(m_memoryCtx, operands[0]->GetValue())
        > Utils::scLinkGetContentFloat(m_memoryCtx, operands[1]->GetValue()))
    {
      FinishExecutionSuccessfully();
    }
    else
    {
      ...
      Utils::scLinkContentIsDouble(m_memoryCtx, operands[0]->GetValue())
      && Utils::scLinkContentIsDouble(m_memoryCtx, operands[1]->GetValue()))
  {
    std::cout << "Links are double" << std::endl;
    if (Utils::scLinkGetContentDouble(m_memoryCtx, operands[0]->GetValue())
        > Utils::scLinkGetContentDouble(m_memoryCtx, operands[1]->GetValue()))
    {
      FinishExecutionSuccessfully();
    }
    else
  ...
  {
    if ((!Utils::scLinkPlainNumbers(m_memoryCtx, operands[0]->GetValue()).empty())
        && (!Utils::scLinkPlainNumbers(m_memoryCtx, operands[1]->GetValue()).empty()))
    {
