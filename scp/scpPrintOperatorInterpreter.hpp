...
class ASCPPrintOperatorInterpreter : public ScAgent<ScEventAfterGenerateOutgoingArc<ScType::EdgeAccessConstPosPerm>>
{
public:
  ...
  static inline ScKeynode const msAgentKeynode{"sc_agent_of_scp_operator_print_interpreting"};
