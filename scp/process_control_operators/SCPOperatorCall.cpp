...
sc_result SCPOperatorCall::Execute()
{
    ...
    ScAddr process_node;
    ScIterator5Ptr iter_temp =m_memoryCtx.Iterator5(program_node, ScType::EdgeAccessConstPosPerm, ScType::NodeVar, ScType::EdgeAccessConstPosPerm, Keynodes::rrel_key_sc_element);
    ...
    ScIterator5Ptr iter_params =m_memoryCtx.Iterator5(process_node, ScType::EdgeAccessVarPosPerm, ScType::NodeVar, ScType::EdgeAccessConstPosPerm, program_node);
