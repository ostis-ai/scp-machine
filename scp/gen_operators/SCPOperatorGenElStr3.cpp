...
SCPOperatorGenElStr3::SCPOperatorGenElStr3(ScAgentContext & ctx, ScAddr addr)
...
sc_result SCPOperatorGenElStr3::Execute()
{
  ...
  case 0x101:
  {
    ...
    operands[1]->SetValue(m_memoryCtx.GenerateConnector(operands[1]->GetType(), elem1, elem3));
    break;
  }
  case 0x001:
  {
