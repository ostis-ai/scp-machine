...
ASCPStringOperatorInterpreter::ASCPStringOperatorInterpreter()
{
  m_logger = utils::ScLogger(
      utils::ScLogger::ScLogType::File, "logs/ASCPStringOperatorInterpreter.log", utils::ScLogLevel::Debug, true);
}
