...
ASCPVarValueOperatorInterpreter::ASCPVarValueOperatorInterpreter()
{
  m_logger = utils::ScLogger(
      utils::ScLogger::ScLogType::File, "logs/ASCPVarValueOperatorInterpreter.log", utils::ScLogLevel::Debug, true);
}
