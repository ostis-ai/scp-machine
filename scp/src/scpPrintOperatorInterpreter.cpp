...
ASCPPrintOperatorInterpreter::ASCPPrintOperatorInterpreter()
{
  m_logger = utils::ScLogger(
      utils::ScLogger::ScLogType::File, "logs/ASCPPrintOperatorInterpreter.log", utils::ScLogLevel::Debug, true);
}
