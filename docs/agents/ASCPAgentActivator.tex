...
\scntext{примечание}{Первичным условием инициирования агента активации scp-агента является появление выходящей постоянной константной sc-дуги принадлежности из класса active\_sc\_agent.}
\begin{scnrelfromvector}{задача}
	\scnfileitem{Подписать активного агента на его первичное условие инициирования.}
