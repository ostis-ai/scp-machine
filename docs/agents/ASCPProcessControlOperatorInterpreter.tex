...
\scntext{примечание}{Первичным условием инициирования агента интерпретации оператора управления scp-процессами является появление выходящей постоянной константной sc-дуги принадлежности из класса active\_action.}
...
\end{scnrelfromset}
\begin{scnrelfromset}{не реализованные операторы}
