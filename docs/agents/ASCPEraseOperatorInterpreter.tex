...
\scntext{примечание}{Первичным условием инициирования агента интерпретации оператора удаления конструкций является появление выходящей постоянной константной sc-дуги принадлежности из класса active\_action.}
